...
async function handleCommandRun(req, res) {
...
async function handleFilesList(_req, res, url) {
...
const ROUTE_HANDLERS = {
  ...
  'POST /command/run': handleCommandRun,
  'POST /files/write': handleFilesWrite,
  'POST /files/read': handleFilesRead,
  'GET /files/list': handleFilesList,
};
